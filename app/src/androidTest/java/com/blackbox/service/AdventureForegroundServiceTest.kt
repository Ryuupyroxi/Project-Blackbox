...
import com.blackbox.module.kai.service.AdventureForegroundService
...
class AdventureForegroundServiceTest {

    @Test
    fun service_startsAndBinds() {
        val context = ApplicationProvider.getApplicationContext<Context>()
        val intent = Intent(context, AdventureForegroundService::class.java)
