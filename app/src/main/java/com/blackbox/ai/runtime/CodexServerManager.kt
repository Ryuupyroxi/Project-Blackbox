package com.blackbox.ai.runtime
...
#!/data/user/0/com.blackbox.ai/files/usr/bin/sh
exec /data/user/0/com.blackbox.ai/files/usr/bin/node /data/user/0/com.blackbox.ai/files/usr/lib/node_modules/@openai/codex/bin/codex.js "${'$'}@"
WEOF
...
#!/data/user/0/com.blackbox.ai/files/usr/bin/sh
exec /data/user/0/com.blackbox.ai/files/usr/bin/node /data/user/0/com.blackbox.ai/files/usr/lib/node_modules/npm/bin/npm-cli.js "${'$'}@"
WEOF
